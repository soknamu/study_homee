...
class Omok(object):
    ...
    def set_image_font(self):
        black_img = pygame.image.load('./keras_prac/image/black.png')
        white_img = pygame.image.load('./keras_prac/image/white.png')
        self.last_w_img = pygame.image.load('./keras_prac/image/white_a.png')
        self.last_b_img = pygame.image.load('./keras_prac/image/black_a.png')
        self.board_img = pygame.image.load('./keras_prac/image/board.png')
        self.forbidden_img = pygame.image.load('./keras_prac/image/forbidden.png')
