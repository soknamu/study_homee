...
# '엄청': 8, '먹었다': 9, '지구용사': 10, '배환희다': 11, '멋있다': 12, '얘기해부아': 13}


#print(token.word_counts)
#OrderedDict([('나는', 2), ('진짜', 1), ('매우', 2), ('맛있는', 1), ('밥을', 1), ('엄청', 1), 
# ('마구', 3), ('먹었다', 1), ('지구용사', 1), ('배환희다', 1), ('멋있다', 1), ('또', 2), ('얘기해부아', 1)])

x = token.texts_to_sequences([text1, text2])
print(x) #[[2, 5, 3, 3, 6, 7, 8, 1, 1, 1, 9], [2, 10, 11, 12, 4, 4, 13]]
print(type(x)) #<class 'list'>

#list는 이렇게 더해줌으로써 한줄로 가능.
x = x[0] + x[1]
#print(x)
...
# x = to_categorical(x)
# print(x)
# print(x.shape) #(18, 14) 원래는 18,13이어야되는데 categorical특성상 0부터시작해서 14가됨.
